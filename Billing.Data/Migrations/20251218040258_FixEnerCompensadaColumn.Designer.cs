...
namespace MoveEnergia.Billing.Data.Migrations
{
    ...
    [Migration("20251218040258_FixEnerCompensadaColumn")]
    partial class FixEnerCompensadaColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoveEnergia.Billing.Core.Entity.LeituraFaturaLinha", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal?>("ICMSAliq")
                        .HasPrecision(10, 4)
                        .HasColumnType("decimal(10,4)")
                        .HasColumnName("icmsaliq");

                    b.Property<decimal?>("ICMSBaseCalc")
                        .HasPrecision(10, 4)
                        .HasColumnType("decimal(10,4)")
                    ...
                    b.HasIndex("FaturaPDFId");

                    b.ToTable("LeituraFaturaLinha", "dbo");
                });
            ...
            modelBuilder.Entity("MoveEnergia.Billing.Core.Entity.LeituraFaturaPdf", b =>
                {
                    ...
                    b.Property<DateTime?>("LeituraAnterior")
                        .HasColumnType("datetime2")
                        .HasColumnName("leianterior");

                    b.Property<DateTime?>("LeituraAtual")
                        .HasColumnType("datetime2")
            ...
            modelBuilder.Entity("MoveEnergia.Billing.Core.Entity.LeituraFaturaLinha", b =>
                {
                    b.HasOne("MoveEnergia.Billing.Core.Entity.LeituraFaturaPdf", "FaturaPDF")
                        .WithMany("Linhas")
                        .HasForeignKey("FaturaPDFId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
